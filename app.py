    ...
    if user_input:
        ...
        with st.chat_message("assistant"):
            ...
            dynamic_system = (
                ...
                f"→ If web results lack the detail needed, say: 'I don't have reliable live data right now "
                f"— check BBC Sport or the official site for the latest {_split_season} standings.'\n\n"
