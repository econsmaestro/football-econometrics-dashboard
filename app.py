    ...
    if user_input:
        ...
        with st.chat_message("assistant"):
            ...
            dynamic_system = (
                ...
                "Today's date is " + _today_str + ". The current European club season is " + _split_season + ".\n\n"
                + _mem_block
                + (
                    ...
                    "→ For title-race or relegation questions: check the web results for current points "
                    "and games remaining before drawing any conclusion.\n"
                    "→ If web results lack the detail needed, say: 'I don't have reliable live data right now "
                    "— check BBC Sport or the official site for the latest " + _split_season + " standings.'\n\n"
                    "FUTURE SEASON questions (next season predictions, title odds for upcoming season, "
                    "transfer window speculation, preseason favourites):\n"
                    "→ You may use your training knowledge and general football reasoning to give a "
                    "considered response. Clearly state it is a prediction or preseason assessment, not live fact.\n"
                    "→ If web results contain relevant recent context (e.g. confirmed signings, manager changes), "
