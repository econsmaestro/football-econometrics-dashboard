...
- **2026-02-12**: Added season rebasing — seasons with different numbers of games (e.g. PL's 42-game era before 1995-96) are automatically scaled to the league's current standard (e.g. 38 games) for fair cross-season comparison. Only complete seasons are rebased; in-progress seasons keep actual values. Visual indicators show when rebasing has been applied in League Table, Statistical Analysis, and Team Insights tabs.
